...
\begin{frame}{Our contribution: when is the forest actually repaired?}
  ...
  \end{center}
  \note{To claim the repair wins that race, you need a date for the repair,
    and everything the paper concludes rests on that single date. Here is
    the one it uses: the moment the very first tree out of ten is replaced.
    Wait until three quarters of the forest has actually been renewed, and
    you wait roughly ten times longer. So that stopwatch times the start of
