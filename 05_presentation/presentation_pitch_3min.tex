...
\begin{frame}{Where we stand}
  \begin{itemize}
    ...
    \item[\textbf{Open}] what should replace that stopwatch is a research
          question of its own. We have started testing candidates, and none
          has passed our bar yet.
  \end{itemize}
  \vfill
  \begin{center}
    \large Thank you.
  ...
  \note{Where we stand. Yes, the alarm really does stay silent, and we
    ...
    pick. And finding a better stopwatch is a research question of its own:
    we have started testing candidates, and none has passed our bar yet.
    Thank you.}
\end{frame}
