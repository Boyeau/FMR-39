...
\begin{frame}{The first replacement is the earliest possible date}
  ...
  \end{itemize}
  % Cette note est la plus longue et, en francais, elle depassait le bas de sa
  % page : la fin n'etait pas rendue. \small la fait tenir. Texte inchange.
  \note{\footnotesize L'article date la réparation au premier arbre remplacé. Par construction, c'est la
