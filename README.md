...
- **`01_consignes/`** — `Sujet39.pdf` (l'énoncé officiel, 4 questions A-D) et `Consignes_études_de_cas_2026-2027.pdf` (cadre général de la filière : calendrier, livrables, grille d'évaluation).
...
- **`02_biblio/`** — synthèse bibliographique (`Bibliographie_Sujet39.docx`) + PDF des articles en accès libre ou récupérés via la bibliothèque.
- **`03_repo_officiel_TheBlindSpotParadox-ICDM2026/`** — copie du dépôt d'expériences de l'article source (*The Blind Spot Paradox*, soumis IEEE ICDM 2026), récupérée le 2026-09-03 au commit `9d28823976c0563ef955eb95a5efeccd7d7c4492`.
