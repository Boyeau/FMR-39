...
\section{Confrontation with the Experimental Side (Q C.1)}
...
bias, verified without exception across the campaign's 2{,}000 runs. This is exactly
the direction of the bias established here~: positive dependence between trees
(Section 2, Jensen) implies that the forest's true adaptation speed is slower than what
the article's independence assumption would predict. The two results are obtained via
completely independent routes --- one theoretical and data-free, the other empirical
and assumption-free --- and they converge exactly on the sign of the bias. It is this
kind of cross-validation, rather than an isolated answer to each question, that gives
the overall diagnosis its value.
