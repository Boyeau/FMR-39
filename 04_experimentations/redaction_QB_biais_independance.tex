...
$S$ is the stream trajectory $(x_t, y_t)$ alone, without the trees' internal draws (in the
campaign a single seed drives both, so $G_S$ cannot be estimated across seeds); $U_i$ the
randomness specific
